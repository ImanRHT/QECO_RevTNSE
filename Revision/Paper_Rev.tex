...
\begin{table*}[tbp]\textcolor{blue}{
		...
		\scalebox{1.05}{
			\begin{tabular}{ lp{4.4cm}p{0.5cm}p{0.6cm}p{0.4cm}p{0.8cm}p{2.2cm}p{3.7cm}l} 
				\toprule
...
\textcolor{blue}{Recall that $y_{i,j}(t)$ is the binary offloading indicator. Moreover, among all $j \in \mathcal{J}$, $y_{i,j}=1$ only for one $j$ which is the corresponding EN.}
...
\textcolor{blue}{$\mathcal{E}_i(\boldsymbol{s}_i(t),\boldsymbol{a}_i(t)) = (1-x_i(t)) E_i^{\text{L}}(t)+x_i(t) \bigg( E_i^{\text{T}}(t) + $\vspace{0mm}
\begin{alignat}{1}
