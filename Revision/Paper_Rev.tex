...
\begin{itemize}
	...
	\item \textit{DRL-based Offloading Algorithm:} To address the problem of long-term QoE maximization, we focus on task completion, task delay, and energy consumption to quantify the MDs' QoE. We propose QECO algorithm based on DRL that empowers each MD to make offloading decisions independently, without prior knowledge of the other MDs' tasks and offloading models. With a focus on the MD's \textcolor{blue}{energy level}, our approach leverages \textcolor{blue}{dueling double deep Q-network (D3QN)} \cite{wang2016dueling} and long short-term memory (LSTM) \cite{hochreiter1997long} to prioritize and strike an appropriate balance between QoE factors. We also analyze the training convergence and complexity of the proposed algorithm.
...
\begin{figure}
	...
	\vspace*{-3mm}
	\caption{\textcolor{blue}{The convergence of the average QoE across episodes under different optimization modules.}}
	\vspace*{-3mm}
	\label{chart01}
\end{figure}
