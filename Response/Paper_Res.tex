...
(c) Indeed, QECO improves the number of completed tasks by 12.2\% while at the same time reduces task delay and energy consumption by 11.7\% and 10.8\%, respectively. These together contribute to a significant improvement  in average QoE compared to \cite{qiu2020distributed}. 
To clarify the simulation results, we have revised the Abstract of the manuscript as follows:
	...
	\rev{
				...
				Consequently, it increases the number of completed tasks by 12.2\%, while simultaneously reducing task delay and energy consumption by 11.7\% and 10.8\%, respectively. Together, these improvements align with user preferences, resulting in a significant average QoE enhancement of at least 34.8\% compared to \cite{qiu2020distributed}.
}
